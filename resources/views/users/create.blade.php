...
@section('title')
{{ trans('page_trans.add') }} {{ trans('main_trans.user') }}
@endsection
...
@section('content')
    <div class="row">
        <div class="col-lg-6 margin-tb mb-4">
            <div>
                <h2> {{ trans('page_trans.add') }} {{ trans('main_trans.user') }}
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item active">{{ trans('page_trans.add') }} {{ trans('main_trans.user') }}</li>
        ...
        @csrf
            ...
            <div class=" mb-3">
                <div class="form-group">
                    ...
                    <input value="{{ old('name') }}"  type="text" name="name" class="form-control border boreder-1 mt-1" placeholder="{{ trans('page_trans.name') }}">
                </div>
            </div>
            <div class=" mb-3">
                <div class="form-group">
                    <strong>{{ trans('page_trans.email') }} :</strong>
                    <input value="{{ old('email') }}"  type="email" name="email" class="form-control border boreder-1 mt-1" placeholder="{{ trans('page_trans.email') }}">
                </div>
            </div>
            <div class=" mb-3">
                <div class="form-group">
            ...
            <div class=" my-3 text-start">
                <button type="submit" class="btn btn-primary">{{ trans('page_trans.add') }}</button>
